...
?>
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <div class="content">
                            ...
                            <div class="link-box"><a href="" class="theme-btn btn-style-one"><span class="btn-title">Nos jeux</span></a></div>
                        </div>
                    </div>  
                </div>
            </div>
    ...
    <section class="games-section">
        ...
        <div class="auto-container">
            <!--Title-->
            <div class="sec-title centered"><h2>Les derniers jeux</h2><span class="bottom-curve"></span></div>
    ...
    <section class="dual-section">
        ...
        <div class="home-gallery">
            <div class="auto-container">
                <!--Title-->
                <div class="sec-title centered"><h2>Notre galerie</h2><span class="bottom-curve"></span></div>
